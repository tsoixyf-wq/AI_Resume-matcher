...
RESUME_EXTRACTION_SYSTEM_PROMPT = """你是一位专业的简历信息提取专家。\
你的任务是从简历文本中提取结构化信息。
...
1. 基本信息/Basic Info：姓名/Name、邮箱/Email、电话/Phone、\
所在城市/City、工作年限/Years of Experience
2. 教育经历/Education：学校全称/School、学位/Degree、专业/Major、\
入学时间/Start Date、毕业时间/End Date、\
预计毕业时间/Expected Graduation (应届生/fresh grads)、GPA
3. 工作经历/Work Experience：公司全称/Company、职位/Title、起止时间/Dates、\
工作描述和成就/Description & Achievements、\
雇佣类型/Employment Type (full-time/internship/part-time/contract)
...
4. 技能/Skills：技能名称/Name、掌握程度/Level（\
初级/Beginner 中级/Intermediate 高级/Advanced 精通/Expert）、\
分类/Category（编程语言/Programming 框架/Framework 数据库/Database 工具/Tools \
云平台/Cloud 软技能/Soft Skills 其他/Other）
5. 项目经历/Projects：项目名称/Name、描述/Description、技术栈/Tech Stack、链接/URL
6. 竞赛获奖/Competitions：竞赛名称/Name、级别/Level（\
国际/International 全国/National 省/Provincial 校/School）、\
获奖情况/Award、日期/Date
